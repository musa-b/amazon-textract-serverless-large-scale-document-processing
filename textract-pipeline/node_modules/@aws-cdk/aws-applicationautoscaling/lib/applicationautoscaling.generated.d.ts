...
export interface CfnScalableTargetProps {
     ...
     */
    readonly maxCapacity: number | cdk.Token;
    /**
     ...
     */
    readonly minCapacity: number | cdk.Token;
    /**
     ...
     */
    readonly scheduledActions?: Array<CfnScalableTarget.ScheduledActionProperty | cdk.Token> | cdk.Token;
}
/**
...
export declare class CfnScalableTarget extends cdk.CfnResource {
     ...
     */
    static readonly resourceTypeName = "AWS::ApplicationAutoScaling::ScalableTarget";
    ...
    readonly propertyOverrides: CfnScalableTargetProps;
...
export declare namespace CfnScalableTarget {
    ...
    interface ScheduledActionProperty {
         ...
         */
        readonly endTime?: Date | cdk.Token;
        /**
         ...
         */
        readonly scalableTargetAction?: CfnScalableTarget.ScalableTargetActionProperty | cdk.Token;
        /**
         ...
         */
        readonly startTime?: Date | cdk.Token;
    }
}
/**
...
export interface CfnScalingPolicyProps {
     ...
     */
    readonly stepScalingPolicyConfiguration?: CfnScalingPolicy.StepScalingPolicyConfigurationProperty | cdk.Token;
    /**
     ...
     */
    readonly targetTrackingScalingPolicyConfiguration?: CfnScalingPolicy.TargetTrackingScalingPolicyConfigurationProperty | cdk.Token;
}
/**
...
export declare class CfnScalingPolicy extends cdk.CfnResource {
     ...
     * The CloudFormation resource type name for this resource class.
     */
    static readonly resourceTypeName = "AWS::ApplicationAutoScaling::ScalingPolicy";
    ...
    readonly propertyOverrides: CfnScalingPolicyProps;
    protected renderProperties(properties: any): {
        [key: string]: any;
    };
}
export declare namespace CfnScalingPolicy {
    ...
    interface CustomizedMetricSpecificationProperty {
         ...
         */
        readonly dimensions?: Array<CfnScalingPolicy.MetricDimensionProperty | cdk.Token> | cdk.Token;
        /**
...
export declare namespace CfnScalingPolicy {
    ...
    interface StepAdjustmentProperty {
         ...
         */
        readonly metricIntervalLowerBound?: number | cdk.Token;
        /**
         ...
         */
        readonly metricIntervalUpperBound?: number | cdk.Token;
        /**
         ...
         */
        readonly scalingAdjustment: number | cdk.Token;
    }
}
export declare namespace CfnScalingPolicy {
    /**
    ...
    interface StepScalingPolicyConfigurationProperty {
         ...
         */
        readonly cooldown?: number | cdk.Token;
        /**
         ...
         */
        readonly minAdjustmentMagnitude?: number | cdk.Token;
        /**
         ...
         */
        readonly stepAdjustments?: Array<CfnScalingPolicy.StepAdjustmentProperty | cdk.Token> | cdk.Token;
    }
}
export declare namespace CfnScalingPolicy {
    /**
    ...
    interface TargetTrackingScalingPolicyConfigurationProperty {
         ...
         */
        readonly customizedMetricSpecification?: CfnScalingPolicy.CustomizedMetricSpecificationProperty | cdk.Token;
        /**
         ...
         */
        readonly disableScaleIn?: boolean | cdk.Token;
        /**
         ...
         */
        readonly predefinedMetricSpecification?: CfnScalingPolicy.PredefinedMetricSpecificationProperty | cdk.Token;
        /**
         ...
         */
        readonly scaleInCooldown?: number | cdk.Token;
        /**
         ...
         */
        readonly scaleOutCooldown?: number | cdk.Token;
        /**
         ...
         */
        readonly targetValue: number | cdk.Token;
    }
}
