...
export declare class Fn {
     ...
     * @returns an FnCondition token
     */
    conditionEachMemberEquals(listOfStrings: string[], value: string): ICfnConditionExpression;
    /**
     ...
     * @returns an FnCondition token
     */
    conditionEachMemberIn(stringsToCheck: string[], stringsToMatch: string): ICfnConditionExpression;
    /**
